...
public const string PROFILE_BASE_PDQMPATIENT = "https://profiles.ihe.net/ITI/PDQm/StructureDefinition/IHE.PDQm.Patient";
public const RESOURCE_NAME_PDQMPATIENT = "Patient";
...
@r4:ResourceDefinition {
    ...
    elements: {
        ...
        "communication" : {
            name: "communication",
            dataType: PDQmPatientCommunication,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "identifier" : {
            name: "identifier",
            dataType: PDQmPatientIdentifier,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PDQmPatient record {|
    *r4:DomainResource;

    RESOURCE_NAME_PDQMPATIENT resourceType = RESOURCE_NAME_PDQMPATIENT;

    r4:Extension [] extension?;
    PDQmPatientGender gender?;
    r4:Extension [] modifierExtension?;
    PDQmPatientLink [] link?;
    r4:code language?;
    PDQmPatientContact [] contact?;
    r4:dateTime deceasedDateTime?;
    r4:Reference [] generalPractitioner?;
    r4:ContactPoint [] telecom?;
    string id?;
    r4:Narrative text?;
    PDQmPatientCommunication [] communication?;
    @constraint:Array {
        minLength: {
            value: 1,
    ...
    PDQmPatientIdentifier [] identifier;
    r4:Address [] address?;
...
public type PDQmPatientCommunication record {|
    *r4:BackboneElement;
...
# + modifierExtension - May be used to represent additional information that is not part of the basic definition of the element and that modifies the understanding of the element in which it is contained and/or the understanding of the containing element's descendants. Usually modifier elements provide negation or qualification. To make the use of extensions safe and manageable, there is a strict set of governance applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension. Applications processing a resource are required to check for modifier extensions. Modifier extensions SHALL NOT change the meaning of any elements on Resource or DomainResource (including cannot change the meaning of modifierExtension itself).
# + id - Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
# + 'type - The type of link between this patient resource and another patient resource. When this Patient Resource has been subsumed by another, the type SHALL be replaced-by.

@r4:DataTypeDefinition {
    name: "PDQmPatientLink",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "type": {
            name: "type",
            dataType: PDQmPatientLinkType,
            min: 1,
            max: 1,
            isArray: false,
            description: "The type of link between this patient resource and another patient resource. When this Patient Resource has been subsumed by another, the type SHALL be replaced-by.",
...
public type PDQmPatientLink record {|
    *r4:BackboneElement;
    ...
    r4:Extension [] modifierExtension?;
    string id?;
    PDQmPatientLinkType 'type;
|};


# PDQmPatientIdentifierUse enum
public enum PDQmPatientIdentifierUse {
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "gender": {
            name: "gender",
            dataType: PDQmPatientContactGender,
            min: 0,
            max: 1,
            isArray: false,
...
public type PDQmPatientContact record {|
    *r4:BackboneElement;

    r4:Extension [] extension?;
    r4:Period period?;
    r4:Address address?;
    PDQmPatientContactGender gender?;
    r4:Extension [] modifierExtension?;
...
public enum PDQmPatientLinkType {
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "use": {
            name: "use",
            dataType: PDQmPatientIdentifierUse,
            min: 0,
            max: 1,
            isArray: false,
...
public type PDQmPatientIdentifier record {|
    *r4:Identifier;

    r4:Extension [] extension?;
    r4:Period period?;
    r4:uri system;
    PDQmPatientIdentifierUse use?;
...
public enum PDQmPatientContactGender {
    CODE_GENDER_OTHER = "other",
    CODE_GENDER_FEMALE = "female",
    CODE_GENDER_MALE = "male",
    CODE_GENDER_UNKNOWN = "unknown"
