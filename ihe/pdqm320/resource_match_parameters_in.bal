...
public const string PROFILE_BASE_MATCHPARAMETERSIN = "https://profiles.ihe.net/ITI/PDQm/StructureDefinition/IHE.PDQm.MatchParametersIn";
public const RESOURCE_NAME_MATCHPARAMETERSIN = "Parameters";
...
# + 'parameter - A parameter passed to or received from the operation.
    # * parameter Slicings
        # 1) MatchParametersInParameterResource: Operation Parameter
        #       - min = 1
        #       - max = 1
        #
        # 2) MatchParametersInParameterOnlyCertainMatches: Operation Parameter
        #       - min = 0
        #       - max = 1
        #
        # 3) MatchParametersInParameterCount: Operation Parameter
        #       - min = 0
        #       - max = 1
        #
...
@r4:ResourceDefinition {
    ...
    profile: "https://profiles.ihe.net/ITI/PDQm/StructureDefinition/IHE.PDQm.MatchParametersIn",
    elements: {
        "meta" : {
            name: "meta",
            dataType: r4:Meta,
        ...
        "parameter" : {
            name: "parameter",
            dataType: MatchParametersInParameter,
            min: 1,
            max: 3,
            isArray: true,
...
public type MatchParametersIn record {|
    *r4:DomainResource;

    RESOURCE_NAME_MATCHPARAMETERSIN resourceType = RESOURCE_NAME_MATCHPARAMETERSIN;
...
@r4:DataTypeDefinition {
    name: "MatchParametersInParameterOnlyCertainMatches",
    baseType: (),
    elements: {
        "valueBoolean": {
            name: "valueBoolean",
...
public type MatchParametersInParameterOnlyCertainMatches record {|
    *MatchParametersInParameter;
...
@r4:DataTypeDefinition {
    name: "MatchParametersInParameter",
    baseType: (),
    elements: {
        "valueTime": {
            name: "valueTime",
...
public type MatchParametersInParameter record {|
    *r4:BackboneElement;
...
# + valueCount - If the parameter is a data type.
# + valueId - If the parameter is a data type.
# + 'resource - Demographics and other administrative information about an individual or animal receiving care or other health-related services.
# + valueCode - If the parameter is a data type.
# + valueAddress - If the parameter is a data type.
# + valueContactPoint - If the parameter is a data type.
# + valuePeriod - If the parameter is a data type.
...
@r4:DataTypeDefinition {
    name: "MatchParametersInParameterResource",
    baseType: (),
    elements: {
        "valueTime": {
            name: "valueTime",
...
public type MatchParametersInParameterResource record {|
    *MatchParametersInParameter;
...
@r4:DataTypeDefinition {
    name: "MatchParametersInParameterCount",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type MatchParametersInParameterCount record {|
    *MatchParametersInParameter;
