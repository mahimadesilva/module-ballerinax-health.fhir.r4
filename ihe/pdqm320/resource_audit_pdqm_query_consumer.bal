...
public const string PROFILE_BASE_AUDITPDQMQUERYCONSUMER = "https://profiles.ihe.net/ITI/PDQm/StructureDefinition/IHE.PDQm.Query.Audit.Consumer";
public const RESOURCE_NAME_AUDITPDQMQUERYCONSUMER = "AuditEvent";
...
# + agent - An actor taking an active role in the event or activity that is logged.
    # * agent Slicings
        # 1) AuditPdqmQueryConsumerAgentServer: Patient Demographics Supplier
        #       - min = 1
        #       - max = 1
        #
        # 2) AuditPdqmQueryConsumerAgentClient: Patient Demographics Consumer
        #       - min = 1
        #       - max = 1
        #
        # 3) AuditPdqmQueryConsumerAgentUser: Actor involved in the event
        #       - min = 0
        #       - max = 1
        #
...
# + subtype - Identifier for the category of event.
    # * subtype Slicings
        # 1) AuditPdqmQueryConsumerSubtypeIti78: More specific type/id for the event
        #       - min = 1
        #       - max = 1
        #
        # 2) AuditPdqmQueryConsumerSubtypeAnySearch: More specific type/id for the event
        #       - min = 1
        #       - max = 1
        #
...
# + entity - Specific instances of data or objects that have been accessed.
    # * entity Slicings
        # 1) AuditPdqmQueryConsumerEntityPatient: Patient
        #       - min = 0
        #       - max = 1
        #
        # 2) AuditPdqmQueryConsumerEntityQuery: Search Parameters
        #       - min = 1
        #       - max = 1
        #
        # 3) AuditPdqmQueryConsumerEntityTransaction: Data or objects used
        #       - min = 0
        #       - max = 1
        #
...
@r4:ResourceDefinition {
    ...
    elements: {
        "agent" : {
            name: "agent",
            dataType: AuditPdqmQueryConsumerAgent,
            min: 2,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "source" : {
            name: "source",
            dataType: AuditPdqmQueryConsumerSource,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "type" : {
            name: "type",
            dataType: AuditPdqmQueryConsumerType,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "entity" : {
            name: "entity",
            dataType: AuditPdqmQueryConsumerEntity,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type AuditPdqmQueryConsumer record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUDITPDQMQUERYCONSUMER resourceType = RESOURCE_NAME_AUDITPDQMQUERYCONSUMER;
    ...
    AuditPdqmQueryConsumerAgent [] agent;
    r4:Extension [] extension?;
    r4:Period period?;
    r4:Extension [] modifierExtension?;
    r4:code language?;
    AuditPdqmQueryConsumerSource 'source;
    AuditPdqmQueryConsumerType 'type;
    r4:instant recorded;
    ...
    AuditPdqmQueryConsumerEntity [] entity;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerEntity",
    baseType: (),
    elements: {
        "lifecycle": {
            name: "lifecycle",
        ...
        "detail": {
            name: "detail",
            dataType: AuditPdqmQueryConsumerEntityDetail,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type AuditPdqmQueryConsumerEntity record {|
    *r4:BackboneElement;
    ...
    string name?;
    string description?;
    AuditPdqmQueryConsumerEntityDetail [] detail?;
    string id?;
    r4:Coding 'type?;
|};
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerAgentNetworkThree",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AuditPdqmQueryConsumerAgentNetworkThree record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerEntityDetail",
    baseType: (),
    elements: {
        "valueBase64Binary": {
...
public type AuditPdqmQueryConsumerEntityDetail record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerSource",
    baseType: (),
    elements: {
        "observer": {
            name: "observer",
...
public type AuditPdqmQueryConsumerSource record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerEntityQuery",
    baseType: (),
    elements: {
        "lifecycle": {
            name: "lifecycle",
        ...
        "role": {
            name: "role",
            dataType: AuditPdqmQueryConsumerEntityRoleOne,
            min: 1,
            max: 1,
            isArray: false,
            description: "Code representing the role the entity played in the event being audited.",
        ...
        "detail": {
            name: "detail",
            dataType: AuditPdqmQueryConsumerEntityDetailTwo,
            min: 0,
            max: 0,
            isArray: true,
            description: "Tagged value pairs for conveying additional information about the entity.",
        ...
        "type": {
            name: "type",
            dataType: AuditPdqmQueryConsumerEntityTypeOne,
            min: 1,
            max: 1,
            isArray: false,
            description: "The type of the object that was involved in this audit event.",
...
public type AuditPdqmQueryConsumerEntityQuery record {|
    *AuditPdqmQueryConsumerEntity;

    r4:Coding lifecycle?;
    r4:Extension [] extension?;
    AuditPdqmQueryConsumerEntityRoleOne role;
    r4:Reference what?;
    r4:Coding [] securityLabel?;
    r4:Extension [] modifierExtension?;
    r4:base64Binary query;
    string name?;
    string description?;
    AuditPdqmQueryConsumerEntityDetailTwo [] detail?;
    string id?;
    AuditPdqmQueryConsumerEntityTypeOne 'type;
|};
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerEntityRoleOne",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmQueryConsumerEntityRoleOne record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerAgentTypeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmQueryConsumerAgentTypeCoding record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerEntityDetailThree",
    baseType: (),
    elements: {
        "valueBase64Binary": {
            name: "valueBase64Binary",
...
public type AuditPdqmQueryConsumerEntityDetailThree record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerSubtypeIti78",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmQueryConsumerSubtypeIti78 record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerEntityRole",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmQueryConsumerEntityRole record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerAgentNetworkTwo",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AuditPdqmQueryConsumerAgentNetworkTwo record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerAgentTypeCodingOne",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmQueryConsumerAgentTypeCodingOne record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerEntityTypeTwo",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmQueryConsumerEntityTypeTwo record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerEntityPatient",
    baseType: (),
    elements: {
        "lifecycle": {
            name: "lifecycle",
        ...
        "role": {
            name: "role",
            dataType: AuditPdqmQueryConsumerEntityRole,
            min: 0,
            max: 1,
            isArray: false,
            description: "Code representing the role the entity played in the event being audited.",
        ...
        "detail": {
            name: "detail",
            dataType: AuditPdqmQueryConsumerEntityDetailOne,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
            description: "Tagged value pairs for conveying additional information about the entity.",
        ...
        "type": {
            name: "type",
            dataType: AuditPdqmQueryConsumerEntityType,
            min: 1,
            max: 1,
            isArray: false,
            description: "The type of the object that was involved in this audit event.",
...
public type AuditPdqmQueryConsumerEntityPatient record {|
    *AuditPdqmQueryConsumerEntity;

    r4:Coding lifecycle?;
    r4:Extension [] extension?;
    AuditPdqmQueryConsumerEntityRole role?;
    r4:Reference what;
    r4:Coding [] securityLabel?;
    r4:Extension [] modifierExtension?;
    r4:base64Binary query?;
    string name?;
    string description?;
    AuditPdqmQueryConsumerEntityDetailOne [] detail?;
    string id?;
    AuditPdqmQueryConsumerEntityType 'type;
|};
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerAgentType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AuditPdqmQueryConsumerAgentTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type AuditPdqmQueryConsumerAgentType record {|
    *r4:CodeableConcept;
    ...
    AuditPdqmQueryConsumerAgentTypeCoding [] coding;
|};
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerAgentNetwork",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AuditPdqmQueryConsumerAgentNetwork record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerAgentTypeTwo",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AuditPdqmQueryConsumerAgentTypeCodingTwo,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type AuditPdqmQueryConsumerAgentTypeTwo record {|
    *r4:CodeableConcept;
    ...
    AuditPdqmQueryConsumerAgentTypeCodingTwo [] coding;
|};
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerEntityTransaction",
    baseType: (),
    elements: {
        "lifecycle": {
            name: "lifecycle",
        ...
        "detail": {
            name: "detail",
            dataType: AuditPdqmQueryConsumerEntityDetailThree,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
            description: "Tagged value pairs for conveying additional information about the entity.",
        ...
        "type": {
            name: "type",
            dataType: AuditPdqmQueryConsumerEntityTypeTwo,
            min: 1,
            max: 1,
            isArray: false,
            description: "The type of the object that was involved in this audit event.",
...
public type AuditPdqmQueryConsumerEntityTransaction record {|
    *AuditPdqmQueryConsumerEntity;
    ...
    string name?;
    string description?;
    AuditPdqmQueryConsumerEntityDetailThree [] detail?;
    string id?;
    AuditPdqmQueryConsumerEntityTypeTwo 'type;
|};
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerAgentNetworkOne",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AuditPdqmQueryConsumerAgentNetworkOne record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerAgentClient",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "type": {
            name: "type",
            dataType: AuditPdqmQueryConsumerAgentTypeOne,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "network": {
            name: "network",
            dataType: AuditPdqmQueryConsumerAgentNetworkTwo,
            min: 1,
            max: 1,
            isArray: false,
...
public type AuditPdqmQueryConsumerAgentClient record {|
    *AuditPdqmQueryConsumerAgent;
    ...
    r4:Extension [] modifierExtension?;
    r4:Coding media?;
    AuditPdqmQueryConsumerAgentTypeOne 'type;
    string altId?;
    boolean requestor;
    AuditPdqmQueryConsumerAgentNetworkTwo network;
    string name?;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerEntityDetailOne",
    baseType: (),
    elements: {
        "valueBase64Binary": {
            name: "valueBase64Binary",
...
public type AuditPdqmQueryConsumerEntityDetailOne record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerType",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmQueryConsumerType record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerEntityType",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmQueryConsumerEntityType record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerAgentServer",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "type": {
            name: "type",
            dataType: AuditPdqmQueryConsumerAgentType,
            min: 1,
            max: 1,
            isArray: false,
            description: "Specification of the participation type the user plays when performing the event.",
        ...
        "network": {
            name: "network",
            dataType: AuditPdqmQueryConsumerAgentNetworkOne,
            min: 1,
            max: 1,
            isArray: false,
            description: "Logical network location for application activity, if the activity has a network location.",
...
public type AuditPdqmQueryConsumerAgentServer record {|
    *AuditPdqmQueryConsumerAgent;
    ...
    r4:Extension [] modifierExtension?;
    r4:Coding media?;
    AuditPdqmQueryConsumerAgentType 'type;
    string altId?;
    boolean requestor;
    AuditPdqmQueryConsumerAgentNetworkOne network;
    string name?;
    r4:Reference location?;
    string id?;
    r4:uri [] policy?;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerEntityTypeOne",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmQueryConsumerEntityTypeOne record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerAgentUser",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "type": {
            name: "type",
            dataType: AuditPdqmQueryConsumerAgentTypeTwo,
            min: 1,
            max: 1,
            isArray: false,
            description: "Specification of the participation type the user plays when performing the event.",
        ...
        "network": {
            name: "network",
            dataType: AuditPdqmQueryConsumerAgentNetworkThree,
            min: 0,
            max: 0,
            isArray: false,
            description: "Logical network location for application activity, if the activity has a network location.",
...
public type AuditPdqmQueryConsumerAgentUser record {|
    *AuditPdqmQueryConsumerAgent;
    ...
    r4:Extension [] modifierExtension?;
    r4:Coding media?;
    AuditPdqmQueryConsumerAgentTypeTwo 'type;
    string altId?;
    boolean requestor;
    AuditPdqmQueryConsumerAgentNetworkThree network?;
    string name?;
    r4:Reference location?;
    string id?;
    r4:uri [] policy?;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerAgent",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "network": {
            name: "network",
            dataType: AuditPdqmQueryConsumerAgentNetwork,
            min: 0,
            max: 1,
            isArray: false,
            description: "Logical network location for application activity, if the activity has a network location.",
...
public type AuditPdqmQueryConsumerAgent record {|
    *r4:BackboneElement;
    ...
    string altId?;
    boolean requestor;
    AuditPdqmQueryConsumerAgentNetwork network?;
    string name?;
    r4:Reference location?;
    string id?;
    r4:uri [] policy?;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerEntityDetailTwo",
    baseType: (),
    elements: {
        "valueBase64Binary": {
            name: "valueBase64Binary",
...
public type AuditPdqmQueryConsumerEntityDetailTwo record {|
    *r4:BackboneElement;
...
public enum AuditPdqmQueryConsumerEntityWhatIdentifierUse {
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerSubtypeAnySearch",
    baseType: (),
    elements: {
    },
...
public type AuditPdqmQueryConsumerSubtypeAnySearch record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerAgentTypeOne",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AuditPdqmQueryConsumerAgentTypeCodingOne,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type AuditPdqmQueryConsumerAgentTypeOne record {|
    *r4:CodeableConcept;
    ...
    AuditPdqmQueryConsumerAgentTypeCodingOne [] coding;
|};
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQueryConsumerAgentTypeCodingTwo",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmQueryConsumerAgentTypeCodingTwo record {|
    *r4:Coding;
