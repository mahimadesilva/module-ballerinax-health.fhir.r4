...
public const string PROFILE_BASE_PDQMMATCHINPUT = "https://profiles.ihe.net/ITI/PDQm/StructureDefinition/IHE.PDQm.MatchInputPatient";
public const RESOURCE_NAME_PDQMMATCHINPUT = "Patient";
...
@r4:ResourceDefinition {
    ...
    profile: "https://profiles.ihe.net/ITI/PDQm/StructureDefinition/IHE.PDQm.MatchInputPatient",
    elements: {
        "extension" : {
            name: "extension",
        ...
        "contact" : {
            name: "contact",
            dataType: PDQmMatchInputContact,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "communication" : {
            name: "communication",
            dataType: PDQmMatchInputCommunication,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
...
public type PDQmMatchInput record {|
    *r4:DomainResource;

    RESOURCE_NAME_PDQMMATCHINPUT resourceType = RESOURCE_NAME_PDQMMATCHINPUT;

    r4:Extension [] extension?;
    PDQmMatchInputGender gender?;
    r4:Extension [] modifierExtension?;
    PDQmMatchInputLink [] link?;
    r4:code language?;
    PDQmMatchInputContact [] contact?;
    r4:dateTime deceasedDateTime?;
    r4:Reference [] generalPractitioner?;
    r4:ContactPoint [] telecom?;
    string id?;
    r4:Narrative text?;
    PDQmMatchInputCommunication [] communication?;
...
public enum PDQmMatchInputGender {
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "type": {
            name: "type",
            dataType: PDQmMatchInputLinkType,
            min: 1,
            max: 1,
            isArray: false,
...
public type PDQmMatchInputLink record {|
    *r4:BackboneElement;
    ...
    r4:Extension [] modifierExtension?;
    string id?;
    PDQmMatchInputLinkType 'type;
|};


# PDQmMatchInputLinkType enum
public enum PDQmMatchInputLinkType {
...
public enum PDQmMatchInputContactGender {
    CODE_GENDER_OTHER = "other",
    CODE_GENDER_FEMALE = "female",
    CODE_GENDER_MALE = "male",
    CODE_GENDER_UNKNOWN = "unknown"
...
@r4:DataTypeDefinition {
    ...
    elements: {
        ...
        "gender": {
            name: "gender",
            dataType: PDQmMatchInputContactGender,
            min: 0,
            max: 1,
            isArray: false,
...
public type PDQmMatchInputContact record {|
    *r4:BackboneElement;

    r4:Extension [] extension?;
    r4:Period period?;
    r4:Address address?;
    PDQmMatchInputContactGender gender?;
    r4:Extension [] modifierExtension?;
...
@r4:DataTypeDefinition {
    name: "PDQmMatchInputCommunication",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type PDQmMatchInputCommunication record {|
    *r4:BackboneElement;
