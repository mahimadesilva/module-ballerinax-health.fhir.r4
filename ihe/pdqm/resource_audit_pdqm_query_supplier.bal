...
public const string PROFILE_BASE_AUDITPDQMQUERYSUPPLIER = "https://profiles.ihe.net/ITI/PDQm/StructureDefinition/IHE.PDQm.Query.Audit.Supplier";
public const RESOURCE_NAME_AUDITPDQMQUERYSUPPLIER = "AuditEvent";
...
# + agent - An actor taking an active role in the event or activity that is logged.
    # * agent Slicings
        # 1) AuditPdqmQuerySupplierAgentServer: Patient Demographics Supplier
        #       - min = 1
        #       - max = 1
        #
        # 2) AuditPdqmQuerySupplierAgentClient: Patient Demographics Consumer
        #       - min = 1
        #       - max = 1
        #
        # 3) AuditPdqmQuerySupplierAgentUser: Actor involved in the event
        #       - min = 0
        #       - max = 1
        #
...
# + subtype - Identifier for the category of event.
    # * subtype Slicings
        # 1) AuditPdqmQuerySupplierSubtypeIti78: More specific type/id for the event
        #       - min = 1
        #       - max = 1
        #
        # 2) AuditPdqmQuerySupplierSubtypeAnySearch: More specific type/id for the event
        #       - min = 1
        #       - max = 1
        #
...
# + entity - Specific instances of data or objects that have been accessed.
    # * entity Slicings
        # 1) AuditPdqmQuerySupplierEntityPatient: Patient
        #       - min = 0
        #       - max = 1
        #
        # 2) AuditPdqmQuerySupplierEntityQuery: Search Parameters
        #       - min = 1
        #       - max = 1
        #
        # 3) AuditPdqmQuerySupplierEntityTransaction: Data or objects used
        #       - min = 0
        #       - max = 1
        #
...
@r4:ResourceDefinition {
    ...
    profile: "https://profiles.ihe.net/ITI/PDQm/StructureDefinition/IHE.PDQm.Query.Audit.Supplier",
    elements: {
        "agent" : {
            name: "agent",
            dataType: AuditPdqmQuerySupplierAgent,
            min: 2,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "source" : {
            name: "source",
            dataType: AuditPdqmQuerySupplierSource,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "type" : {
            name: "type",
            dataType: AuditPdqmQuerySupplierType,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "entity" : {
            name: "entity",
            dataType: AuditPdqmQuerySupplierEntity,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type AuditPdqmQuerySupplier record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUDITPDQMQUERYSUPPLIER resourceType = RESOURCE_NAME_AUDITPDQMQUERYSUPPLIER;
    ...
    AuditPdqmQuerySupplierAgent [] agent;
    r4:Extension [] extension?;
    r4:Period period?;
    r4:Extension [] modifierExtension?;
    r4:code language?;
    AuditPdqmQuerySupplierSource 'source;
    AuditPdqmQuerySupplierType 'type;
    r4:instant recorded;
    ...
    AuditPdqmQuerySupplierEntity [] entity;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierAgentNetwork",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AuditPdqmQuerySupplierAgentNetwork record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierAgentTypeTwo",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AuditPdqmQuerySupplierAgentTypeCodingTwo,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type AuditPdqmQuerySupplierAgentTypeTwo record {|
    *r4:CodeableConcept;
    ...
    AuditPdqmQuerySupplierAgentTypeCodingTwo [] coding;
|};
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierAgentType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AuditPdqmQuerySupplierAgentTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type AuditPdqmQuerySupplierAgentType record {|
    *r4:CodeableConcept;
    ...
    AuditPdqmQuerySupplierAgentTypeCoding [] coding;
|};
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierEntityRoleOne",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmQuerySupplierEntityRoleOne record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierEntityDetailThree",
    baseType: (),
    elements: {
        "valueBase64Binary": {
...
public type AuditPdqmQuerySupplierEntityDetailThree record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierAgentNetworkOne",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AuditPdqmQuerySupplierAgentNetworkOne record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierEntityRole",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmQuerySupplierEntityRole record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierEntityType",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmQuerySupplierEntityType record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierType",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmQuerySupplierType record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierEntityTransaction",
    baseType: (),
    elements: {
        "lifecycle": {
            name: "lifecycle",
        ...
        "detail": {
            name: "detail",
            dataType: AuditPdqmQuerySupplierEntityDetailThree,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "type": {
            name: "type",
            dataType: AuditPdqmQuerySupplierEntityTypeTwo,
            min: 1,
            max: 1,
            isArray: false,
...
public type AuditPdqmQuerySupplierEntityTransaction record {|
    *AuditPdqmQuerySupplierEntity;
    ...
    string name?;
    string description?;
    AuditPdqmQuerySupplierEntityDetailThree [] detail?;
    string id?;
    AuditPdqmQuerySupplierEntityTypeTwo 'type;
|};
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierAgentNetworkThree",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AuditPdqmQuerySupplierAgentNetworkThree record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierEntityDetailTwo",
    baseType: (),
    elements: {
        "valueBase64Binary": {
            name: "valueBase64Binary",
...
public type AuditPdqmQuerySupplierEntityDetailTwo record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierAgentServer",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "type": {
            name: "type",
            dataType: AuditPdqmQuerySupplierAgentType,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "network": {
            name: "network",
            dataType: AuditPdqmQuerySupplierAgentNetworkOne,
            min: 1,
            max: 1,
            isArray: false,
...
public type AuditPdqmQuerySupplierAgentServer record {|
    *AuditPdqmQuerySupplierAgent;
    ...
    r4:Extension [] modifierExtension?;
    r4:Coding media?;
    AuditPdqmQuerySupplierAgentType 'type;
    string altId?;
    boolean requestor;
    AuditPdqmQuerySupplierAgentNetworkOne network;
    string name?;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierAgentTypeCodingTwo",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmQuerySupplierAgentTypeCodingTwo record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierEntityTypeOne",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmQuerySupplierEntityTypeOne record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierAgentTypeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmQuerySupplierAgentTypeCoding record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierSource",
    baseType: (),
    elements: {
        "observer": {
            name: "observer",
...
public type AuditPdqmQuerySupplierSource record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierSubtypeIti78",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmQuerySupplierSubtypeIti78 record {|
    *r4:Coding;

    r4:uri system = "urn:ihe:event-type-code";
    r4:code code = "ITI-78";
    string display = "Mobile Patient Demographics Query";
|};
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierEntityDetail",
    baseType: (),
    elements: {
        "valueBase64Binary": {
            name: "valueBase64Binary",
...
public type AuditPdqmQuerySupplierEntityDetail record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierAgentTypeOne",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AuditPdqmQuerySupplierAgentTypeCodingOne,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type AuditPdqmQuerySupplierAgentTypeOne record {|
    *r4:CodeableConcept;
    ...
    AuditPdqmQuerySupplierAgentTypeCodingOne [] coding;
|};
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierEntityQuery",
    baseType: (),
    elements: {
        "lifecycle": {
            name: "lifecycle",
        ...
        "role": {
            name: "role",
            dataType: AuditPdqmQuerySupplierEntityRoleOne,
            min: 1,
            max: 1,
            isArray: false,
            description: "Code representing the role the entity played in the event being audited.",
        ...
        "detail": {
            name: "detail",
            dataType: AuditPdqmQuerySupplierEntityDetailTwo,
            min: 0,
            max: 0,
            isArray: true,
            description: "Tagged value pairs for conveying additional information about the entity.",
        ...
        "type": {
            name: "type",
            dataType: AuditPdqmQuerySupplierEntityTypeOne,
            min: 1,
            max: 1,
            isArray: false,
            description: "The type of the object that was involved in this audit event.",
...
public type AuditPdqmQuerySupplierEntityQuery record {|
    *AuditPdqmQuerySupplierEntity;

    r4:Coding lifecycle?;
    r4:Extension [] extension?;
    AuditPdqmQuerySupplierEntityRoleOne role;
    r4:Reference what?;
    r4:Coding [] securityLabel?;
    r4:Extension [] modifierExtension?;
    r4:base64Binary query;
    string name?;
    string description?;
    AuditPdqmQuerySupplierEntityDetailTwo [] detail?;
    string id?;
    AuditPdqmQuerySupplierEntityTypeOne 'type;
|};


# AuditPdqmQuerySupplierEntityWhatIdentifierUse enum
public enum AuditPdqmQuerySupplierEntityWhatIdentifierUse {
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierAgentTypeCodingOne",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmQuerySupplierAgentTypeCodingOne record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierAgentClient",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "type": {
            name: "type",
            dataType: AuditPdqmQuerySupplierAgentTypeOne,
            min: 1,
            max: 1,
            isArray: false,
            description: "Specification of the participation type the user plays when performing the event.",
        ...
        "network": {
            name: "network",
            dataType: AuditPdqmQuerySupplierAgentNetworkTwo,
            min: 1,
            max: 1,
            isArray: false,
            description: "Logical network location for application activity, if the activity has a network location.",
...
public type AuditPdqmQuerySupplierAgentClient record {|
    *AuditPdqmQuerySupplierAgent;
    ...
    r4:Extension [] modifierExtension?;
    r4:Coding media?;
    AuditPdqmQuerySupplierAgentTypeOne 'type;
    string altId?;
    boolean requestor;
    AuditPdqmQuerySupplierAgentNetworkTwo network;
    string name?;
    r4:Reference location?;
    string id?;
    r4:uri [] policy?;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierAgentUser",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "type": {
            name: "type",
            dataType: AuditPdqmQuerySupplierAgentTypeTwo,
            min: 1,
            max: 1,
            isArray: false,
            description: "Specification of the participation type the user plays when performing the event.",
        ...
        "network": {
            name: "network",
            dataType: AuditPdqmQuerySupplierAgentNetworkThree,
            min: 0,
            max: 0,
            isArray: false,
            description: "Logical network location for application activity, if the activity has a network location.",
...
public type AuditPdqmQuerySupplierAgentUser record {|
    *AuditPdqmQuerySupplierAgent;
    ...
    r4:Extension [] modifierExtension?;
    r4:Coding media?;
    AuditPdqmQuerySupplierAgentTypeTwo 'type;
    string altId?;
    boolean requestor;
    AuditPdqmQuerySupplierAgentNetworkThree network?;
    string name?;
    r4:Reference location?;
    string id?;
    r4:uri [] policy?;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierEntityPatient",
    baseType: (),
    elements: {
        "lifecycle": {
            name: "lifecycle",
        ...
        "role": {
            name: "role",
            dataType: AuditPdqmQuerySupplierEntityRole,
            min: 0,
            max: 1,
            isArray: false,
            description: "Code representing the role the entity played in the event being audited.",
        ...
        "detail": {
            name: "detail",
            dataType: AuditPdqmQuerySupplierEntityDetailOne,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
            description: "Tagged value pairs for conveying additional information about the entity.",
        ...
        "type": {
            name: "type",
            dataType: AuditPdqmQuerySupplierEntityType,
            min: 1,
            max: 1,
            isArray: false,
            description: "The type of the object that was involved in this audit event.",
...
public type AuditPdqmQuerySupplierEntityPatient record {|
    *AuditPdqmQuerySupplierEntity;

    r4:Coding lifecycle?;
    r4:Extension [] extension?;
    AuditPdqmQuerySupplierEntityRole role?;
    r4:Reference what;
    r4:Coding [] securityLabel?;
    r4:Extension [] modifierExtension?;
    r4:base64Binary query?;
    string name?;
    string description?;
    AuditPdqmQuerySupplierEntityDetailOne [] detail?;
    string id?;
    AuditPdqmQuerySupplierEntityType 'type;
|};
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierEntityTypeTwo",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmQuerySupplierEntityTypeTwo record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierSubtypeAnySearch",
    baseType: (),
    elements: {
    },
...
public type AuditPdqmQuerySupplierSubtypeAnySearch record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierAgentNetworkTwo",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AuditPdqmQuerySupplierAgentNetworkTwo record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierAgent",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "network": {
            name: "network",
            dataType: AuditPdqmQuerySupplierAgentNetwork,
            min: 0,
            max: 1,
            isArray: false,
            description: "Logical network location for application activity, if the activity has a network location.",
...
public type AuditPdqmQuerySupplierAgent record {|
    *r4:BackboneElement;
    ...
    string altId?;
    boolean requestor;
    AuditPdqmQuerySupplierAgentNetwork network?;
    string name?;
    r4:Reference location?;
    string id?;
    r4:uri [] policy?;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierEntity",
    baseType: (),
    elements: {
        "lifecycle": {
            name: "lifecycle",
        ...
        "detail": {
            name: "detail",
            dataType: AuditPdqmQuerySupplierEntityDetail,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
            description: "Tagged value pairs for conveying additional information about the entity.",
...
public type AuditPdqmQuerySupplierEntity record {|
    *r4:BackboneElement;
    ...
    string name?;
    string description?;
    AuditPdqmQuerySupplierEntityDetail [] detail?;
    string id?;
    r4:Coding 'type?;
|};
...
@r4:DataTypeDefinition {
    name: "AuditPdqmQuerySupplierEntityDetailOne",
    baseType: (),
    elements: {
        "valueBase64Binary": {
            name: "valueBase64Binary",
...
public type AuditPdqmQuerySupplierEntityDetailOne record {|
    *r4:BackboneElement;
