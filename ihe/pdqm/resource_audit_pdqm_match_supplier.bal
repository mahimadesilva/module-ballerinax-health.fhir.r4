...
public const string PROFILE_BASE_AUDITPDQMMATCHSUPPLIER = "https://profiles.ihe.net/ITI/PDQm/StructureDefinition/IHE.PDQm.Match.Audit.Supplier";
public const RESOURCE_NAME_AUDITPDQMMATCHSUPPLIER = "AuditEvent";
...
# + agent - An actor taking an active role in the event or activity that is logged.
    # * agent Slicings
        # 1) AuditPdqmMatchSupplierAgentServer: Patient Demographics Supplier
        #       - min = 1
        #       - max = 1
        #
        # 2) AuditPdqmMatchSupplierAgentClient: Patient Demographics Consumer
        #       - min = 1
        #       - max = 1
        #
        # 3) AuditPdqmMatchSupplierAgentUser: Actor involved in the event
        #       - min = 0
        #       - max = 1
        #
...
# + subtype - Identifier for the category of event.
    # * subtype Slicings
        # 1) AuditPdqmMatchSupplierSubtypeIti119: More specific type/id for the event
        #       - min = 1
        #       - max = 1
        #
        # 2) AuditPdqmMatchSupplierSubtypeAnySearch: More specific type/id for the event
        #       - min = 1
        #       - max = 1
        #
...
# + entity - Specific instances of data or objects that have been accessed.
    # * entity Slicings
        # 1) AuditPdqmMatchSupplierEntityPatient: Patient
        #       - min = 0
        #       - max = 1
        #
        # 2) AuditPdqmMatchSupplierEntityQuery: Search Parameters
        #       - min = 1
        #       - max = 1
        #
        # 3) AuditPdqmMatchSupplierEntityTransaction: Data or objects used
        #       - min = 0
        #       - max = 1
        #
...
@r4:ResourceDefinition {
    ...
    profile: "https://profiles.ihe.net/ITI/PDQm/StructureDefinition/IHE.PDQm.Match.Audit.Supplier",
    elements: {
        "agent" : {
            name: "agent",
            dataType: AuditPdqmMatchSupplierAgent,
            min: 2,
            max: int:MAX_VALUE,
            isArray: true,
        ...
        "source" : {
            name: "source",
            dataType: AuditPdqmMatchSupplierSource,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "type" : {
            name: "type",
            dataType: AuditPdqmMatchSupplierType,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "entity" : {
            name: "entity",
            dataType: AuditPdqmMatchSupplierEntity,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type AuditPdqmMatchSupplier record {|
    *r4:DomainResource;

    RESOURCE_NAME_AUDITPDQMMATCHSUPPLIER resourceType = RESOURCE_NAME_AUDITPDQMMATCHSUPPLIER;
    ...
    AuditPdqmMatchSupplierAgent [] agent;
    r4:Extension [] extension?;
    r4:Period period?;
    r4:Extension [] modifierExtension?;
    r4:code language?;
    AuditPdqmMatchSupplierSource 'source;
    AuditPdqmMatchSupplierType 'type;
    r4:instant recorded;
    ...
    AuditPdqmMatchSupplierEntity [] entity;
    r4:Element ...;
|};
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierEntityDetailOne",
    baseType: (),
    elements: {
        "valueBase64Binary": {
...
public type AuditPdqmMatchSupplierEntityDetailOne record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierEntityType",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmMatchSupplierEntityType record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierEntityTypeTwo",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmMatchSupplierEntityTypeTwo record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierAgentTypeCodingTwo",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmMatchSupplierAgentTypeCodingTwo record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierEntityRoleOne",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmMatchSupplierEntityRoleOne record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierAgentTypeOne",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AuditPdqmMatchSupplierAgentTypeCodingOne,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
...
public type AuditPdqmMatchSupplierAgentTypeOne record {|
    *r4:CodeableConcept;
    ...
    AuditPdqmMatchSupplierAgentTypeCodingOne [] coding;
|};
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierAgentNetworkOne",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AuditPdqmMatchSupplierAgentNetworkOne record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierEntityQuery",
    baseType: (),
    elements: {
        "lifecycle": {
            name: "lifecycle",
        ...
        "role": {
            name: "role",
            dataType: AuditPdqmMatchSupplierEntityRoleOne,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "detail": {
            name: "detail",
            dataType: AuditPdqmMatchSupplierEntityDetailTwo,
            min: 0,
            max: 0,
            isArray: true,
        ...
        "type": {
            name: "type",
            dataType: AuditPdqmMatchSupplierEntityTypeOne,
            min: 1,
            max: 1,
            isArray: false,
...
public type AuditPdqmMatchSupplierEntityQuery record {|
    *AuditPdqmMatchSupplierEntity;

    r4:Coding lifecycle?;
    r4:Extension [] extension?;
    AuditPdqmMatchSupplierEntityRoleOne role;
    r4:Reference what?;
    ...
    string name?;
    string description?;
    AuditPdqmMatchSupplierEntityDetailTwo [] detail?;
    string id?;
    AuditPdqmMatchSupplierEntityTypeOne 'type;
|};


# AuditPdqmMatchSupplierEntityWhatIdentifierUse enum
public enum AuditPdqmMatchSupplierEntityWhatIdentifierUse {
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierAgentUser",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "type": {
            name: "type",
            dataType: AuditPdqmMatchSupplierAgentTypeTwo,
            min: 1,
            max: 1,
            isArray: false,
        ...
        "network": {
            name: "network",
            dataType: AuditPdqmMatchSupplierAgentNetworkThree,
            min: 0,
            max: 0,
            isArray: false,
...
public type AuditPdqmMatchSupplierAgentUser record {|
    *AuditPdqmMatchSupplierAgent;
    ...
    r4:Extension [] modifierExtension?;
    r4:Coding media?;
    AuditPdqmMatchSupplierAgentTypeTwo 'type;
    string altId?;
    boolean requestor;
    AuditPdqmMatchSupplierAgentNetworkThree network?;
    string name?;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierEntityTransaction",
    baseType: (),
    elements: {
        "lifecycle": {
            name: "lifecycle",
        ...
        "detail": {
            name: "detail",
            dataType: AuditPdqmMatchSupplierEntityDetailThree,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
            description: "Tagged value pairs for conveying additional information about the entity.",
        ...
        "type": {
            name: "type",
            dataType: AuditPdqmMatchSupplierEntityTypeTwo,
            min: 1,
            max: 1,
            isArray: false,
            description: "The type of the object that was involved in this audit event.",
...
public type AuditPdqmMatchSupplierEntityTransaction record {|
    *AuditPdqmMatchSupplierEntity;
    ...
    string name?;
    string description?;
    AuditPdqmMatchSupplierEntityDetailThree [] detail?;
    string id?;
    AuditPdqmMatchSupplierEntityTypeTwo 'type;
|};
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierAgentNetwork",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AuditPdqmMatchSupplierAgentNetwork record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierAgentNetworkThree",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AuditPdqmMatchSupplierAgentNetworkThree record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierEntityDetailThree",
    baseType: (),
    elements: {
        "valueBase64Binary": {
            name: "valueBase64Binary",
...
public type AuditPdqmMatchSupplierEntityDetailThree record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierAgentClient",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "type": {
            name: "type",
            dataType: AuditPdqmMatchSupplierAgentTypeOne,
            min: 1,
            max: 1,
            isArray: false,
            description: "Specification of the participation type the user plays when performing the event.",
        ...
        "network": {
            name: "network",
            dataType: AuditPdqmMatchSupplierAgentNetworkTwo,
            min: 1,
            max: 1,
            isArray: false,
            description: "Logical network location for application activity, if the activity has a network location.",
...
public type AuditPdqmMatchSupplierAgentClient record {|
    *AuditPdqmMatchSupplierAgent;
    ...
    r4:Extension [] modifierExtension?;
    r4:Coding media?;
    AuditPdqmMatchSupplierAgentTypeOne 'type;
    string altId?;
    boolean requestor;
    AuditPdqmMatchSupplierAgentNetworkTwo network;
    string name?;
    r4:Reference location?;
    string id?;
    r4:uri [] policy?;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierEntityDetail",
    baseType: (),
    elements: {
        "valueBase64Binary": {
            name: "valueBase64Binary",
...
public type AuditPdqmMatchSupplierEntityDetail record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierAgentTypeCodingOne",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmMatchSupplierAgentTypeCodingOne record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierAgentType",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AuditPdqmMatchSupplierAgentTypeCoding,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type AuditPdqmMatchSupplierAgentType record {|
    *r4:CodeableConcept;
    ...
    AuditPdqmMatchSupplierAgentTypeCoding [] coding;
|};
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierEntityTypeOne",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmMatchSupplierEntityTypeOne record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierAgentNetworkTwo",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
...
public type AuditPdqmMatchSupplierAgentNetworkTwo record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierSource",
    baseType: (),
    elements: {
        "observer": {
            name: "observer",
...
public type AuditPdqmMatchSupplierSource record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierSubtypeIti119",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmMatchSupplierSubtypeIti119 record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierType",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmMatchSupplierType record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierEntityPatient",
    baseType: (),
    elements: {
        "lifecycle": {
            name: "lifecycle",
        ...
        "role": {
            name: "role",
            dataType: AuditPdqmMatchSupplierEntityRole,
            min: 0,
            max: 1,
            isArray: false,
            description: "Code representing the role the entity played in the event being audited.",
        ...
        "detail": {
            name: "detail",
            dataType: AuditPdqmMatchSupplierEntityDetailOne,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
            description: "Tagged value pairs for conveying additional information about the entity.",
        ...
        "type": {
            name: "type",
            dataType: AuditPdqmMatchSupplierEntityType,
            min: 1,
            max: 1,
            isArray: false,
            description: "The type of the object that was involved in this audit event.",
...
public type AuditPdqmMatchSupplierEntityPatient record {|
    *AuditPdqmMatchSupplierEntity;

    r4:Coding lifecycle?;
    r4:Extension [] extension?;
    AuditPdqmMatchSupplierEntityRole role?;
    r4:Reference what;
    r4:Coding [] securityLabel?;
    r4:Extension [] modifierExtension?;
    r4:base64Binary query?;
    string name?;
    string description?;
    AuditPdqmMatchSupplierEntityDetailOne [] detail?;
    string id?;
    AuditPdqmMatchSupplierEntityType 'type;
|};
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierAgentTypeTwo",
    baseType: (),
    elements: {
        "coding": {
            name: "coding",
            dataType: AuditPdqmMatchSupplierAgentTypeCodingTwo,
            min: 1,
            max: int:MAX_VALUE,
            isArray: true,
            description: "A reference to a code defined by a terminology system.",
...
public type AuditPdqmMatchSupplierAgentTypeTwo record {|
    *r4:CodeableConcept;
    ...
    AuditPdqmMatchSupplierAgentTypeCodingTwo [] coding;
|};
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierEntity",
    baseType: (),
    elements: {
        "lifecycle": {
            name: "lifecycle",
        ...
        "detail": {
            name: "detail",
            dataType: AuditPdqmMatchSupplierEntityDetail,
            min: 0,
            max: int:MAX_VALUE,
            isArray: true,
            description: "Tagged value pairs for conveying additional information about the entity.",
...
public type AuditPdqmMatchSupplierEntity record {|
    *r4:BackboneElement;
    ...
    string name?;
    string description?;
    AuditPdqmMatchSupplierEntityDetail [] detail?;
    string id?;
    r4:Coding 'type?;
|};
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierAgent",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "network": {
            name: "network",
            dataType: AuditPdqmMatchSupplierAgentNetwork,
            min: 0,
            max: 1,
            isArray: false,
            description: "Logical network location for application activity, if the activity has a network location.",
...
public type AuditPdqmMatchSupplierAgent record {|
    *r4:BackboneElement;
    ...
    string altId?;
    boolean requestor;
    AuditPdqmMatchSupplierAgentNetwork network?;
    string name?;
    r4:Reference location?;
    string id?;
    r4:uri [] policy?;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierSubtypeAnySearch",
    baseType: (),
    elements: {
    },
...
public type AuditPdqmMatchSupplierSubtypeAnySearch record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierAgentTypeCoding",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmMatchSupplierAgentTypeCoding record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierEntityDetailTwo",
    baseType: (),
    elements: {
        "valueBase64Binary": {
            name: "valueBase64Binary",
...
public type AuditPdqmMatchSupplierEntityDetailTwo record {|
    *r4:BackboneElement;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierEntityRole",
    baseType: (),
    elements: {
        "system": {
            name: "system",
...
public type AuditPdqmMatchSupplierEntityRole record {|
    *r4:Coding;
...
@r4:DataTypeDefinition {
    name: "AuditPdqmMatchSupplierAgentServer",
    baseType: (),
    elements: {
        "extension": {
            name: "extension",
        ...
        "type": {
            name: "type",
            dataType: AuditPdqmMatchSupplierAgentType,
            min: 1,
            max: 1,
            isArray: false,
            description: "Specification of the participation type the user plays when performing the event.",
        ...
        "network": {
            name: "network",
            dataType: AuditPdqmMatchSupplierAgentNetworkOne,
            min: 1,
            max: 1,
            isArray: false,
            description: "Logical network location for application activity, if the activity has a network location.",
...
public type AuditPdqmMatchSupplierAgentServer record {|
    *AuditPdqmMatchSupplierAgent;
    ...
    r4:Extension [] modifierExtension?;
    r4:Coding media?;
    AuditPdqmMatchSupplierAgentType 'type;
    string altId?;
    boolean requestor;
    AuditPdqmMatchSupplierAgentNetworkOne network;
    string name?;
    r4:Reference location?;
    string id?;
    r4:uri [] policy?;
